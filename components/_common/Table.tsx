...
function transformProps<T>(props: TableProps<T>): TransformedTableProps {
  ...
  const classes = {
    container: "",
    table: "border-collapse w-full secondary",
    header: "px-2 py-1 border-2 border-stone-300 text-left min-h-max",
    row: "text-stone-700 bg-stone-200 border-2 border-stone-300 h-8",
    row2: "text-stone-700 bg-stone-100 border-2 border-stone-300 h-8",
    cell: "px-2",
    pagination: "py-2 flex place-content-center w-full space-x-2 border-2 border-stone-300",
    paginationButton: "secondary border-2 rounded-md w-6 hover:bg-sky-200",
    paginationButtonSelected: "bg-sky-300 border-stone-600 border-2 rounded-md w-6",
    input: "form-control",
